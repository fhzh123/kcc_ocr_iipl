...
from modules.layers import conv_bn_act
from modules.layers import SamePadConv2d
from modules.layers import Flatten
from modules.layers import SEModule
from modules.layers import DropConnect
from modules.layers import MBConv
from modules.layers import MBBlock
...
class EfficientNet_FeatureExtractor(nn.Module):
    def __init__(self, width_coeff, depth_coeff,
        ...
        self.blocks = nn.Sequential(
            ...
            MBBlock(renew_ch(24), renew_ch(32), 6, 3, 1, renew_repeat(2), True, 0.25, drop_connect_rate),
            MBBlock(renew_ch(32), renew_ch(64), 6, 3, 2, renew_repeat(3), True, 0.25, drop_connect_rate),
            MBBlock(renew_ch(64), renew_ch(128), 6, 3, 2, renew_repeat(3), True, 0.25, drop_connect_rate),
            MBBlock(renew_ch(128), renew_ch(256), 6, 3, 2, renew_repeat(4), True, 0.25, drop_connect_rate),
            MBBlock(renew_ch(256), renew_ch(512), 6, 3, 2, renew_repeat(1), True, 0.25, drop_connect_rate)
        )
