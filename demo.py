...
if __name__ == '__main__':
    ...
    parser.add_argument('--saved_model', default="BiLSTM_Attn.pth", help="path to saved_model to evaluation")
    """ Data processing """
    ...
    parser.add_argument('--FeatureExtraction', type=str, default="EfficientNet", help='FeatureExtraction stage. VGG|RCNN|ResNet')
    ...
    if opt.sensitive:
        ...
        char_file = open('../KCC_OCR/dataset/charset_0506.txt', 'r', encoding='utf-16')
