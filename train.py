...
from utils import CTCLabelConverter, TransformerLabelConverter ,AttnLabelConverter, Averager
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgH', type=int, default=480, help='the height of the input image')
    parser.add_argument('--imgW', type=int, default=48, help='the width of the input image')
    ...
    if not opt.experiment_name:
        opt.experiment_name = f'{opt.Transformation}-{opt.FeatureExtraction}-{opt.SequenceModeling}-{opt.Prediction}-last'
    ...
    if opt.sensitive:
        ...
        #char_file = open('../KCC_OCR/dataset/new_charset.txt', 'r', encoding='utf-16')
        char_file = open('charset_0507.txt', 'r', encoding='utf-16')
        opt.character = char_file.read()
        char_file.close()
